...
class MedicalDoctorController extends Controller
{
    ...
    public function index()
    {
        ...
        $medicalDoctors = Medical::where('medical_type', 'Doctor')
        ...
        return view('backend.medicalDoctors.index', compact('medicalDoctors'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.medicalDoctors.create', compact('countries'));
    }
    ...
    public function store(MedicalRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.medicalDoctors.index');
        }
        catch (\Exception $e){
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Medical $medicalDoctor)
    {
        if (!\auth()->user()->ability('superAdmin', 'manage_medicals,show_medicals')) {
            return redirect('admin/index');
        }

        return view('backend.medicalDoctors.show', compact('medical'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Medical $medicalDoctor)
    {
        ...
        return view('backend.medicalDoctors.edit', compact('countries', 'medicalDoctor'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(MedicalRequest $request, Medical $medicalDoctor)
    {
        if (!\auth()->user()->ability('superAdmin', 'manage_medicals,update_medicals')) {
            return redirect('admin/index');
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Medical $medicalDoctor)
    {
