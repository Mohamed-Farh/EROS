...
@section('title', 'انشاء نوع سيارة جديدة')
...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <div class="col-6">
                <h3 class="m-0 font-weight-bold text-primary">{{__('انشاء نوع سيارة جديدة') }}</h3>
            </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.carTypes.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-9">
