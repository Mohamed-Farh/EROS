    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                <div class="col-6">
                    <h3 class="m-0 font-weight-bold text-primary">{{ __('انشاء ممرض جديد') }}</h3>
                </div>
                <div class="col-6 text-right">
                    <a href="{{ route('admin.medicalNurses.index') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('التمريض') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.medicalNurses.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-8">
                        ...
                        <div class="col-3" hidden>
                            <div class="form-group">
                                <label for="medical_type">فئة الممرض</label>
                                <input type="hidden" name="medical_type" value="Nurse" class="form-control">
                                @error('medical_type')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
