...
@section('title', 'انشاء دكتور جديد')
    ...
    <div class="container">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex">
                <div class="col-6">
                    <h3 class="m-0 font-weight-bold text-primary">{{ __('انشاء دكتور جديد') }}</h3>
                </div>
                <div class="col-6 text-right">
                    <a href="{{ route('admin.medicalDoctors.index') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('الطب') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.medicalDoctors.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-8">
                        ...
                        <div class="col-3" hidden>
                            <div class="form-group">
                                <label for="medical_type">فئة الدكتور</label>
                                <input type="hidden" name="medical_type" value="Doctor" class="form-control">
                                @error('medical_type')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
