                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ old('status', $product->status) == 1 ? 'selected' : null }}>نشط
                                </option>
                                <option value="0" {{ old('status', $product->status) == 0 ? 'selected' : null }}>غير نشط
                                </option>
                            </select>
                            @error('status')
                                <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="row mt-6">
                        ...
                        <div class="col-4">
                            ...
                            <select name="featured" class="form-control">
                                ...
                                <option value="0" {{ old('featured', $product->featured) == 0 ? 'selected' : null }}>لا
                                </option>
                            </select>
                            @error('featured')
                                <span class="text-danger">{{ $message }}</span>
                ...
                initialPreviewConfig: [
                    @if ($product->media->count() > 0)
                        @foreach ($product->media as $media)
                            ...
                            width: "120px",
                            url:
                            "{{ route('admin.products.removeImage', ['image_id' => $media->id,'product_id' => $product->id,'_token' => csrf_token()]) }}",
                            key: "{{ $media->id }}"
                            },
                        @endforeach
                    @endif
