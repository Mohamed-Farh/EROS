    ...
    <div class="container">
        <div class="row ">
            <div class="col-6 d-flex text-left">
                <h1 class=" text-left">فئات السيارات</h1>
            </div>
            <div class="col-6 d-flex justify-content-end">
                @ability('superAdmin', 'manage_cars,create_cars')
                <a href="{{ route('admin.carCategories.create') }}" class="btn btn-primary font-weight-bolder">
        ...
        @include('backend.carCategories.filter')
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-bordered table-hover table-striped table-light yajra-datatable">
                    ...
                    <tbody>
                        @foreach ($carCategories as $k => $category)
                            <tr data-entry-id="{{ $category->id }}">
                                ...
                                <td class="text-center">
                                    ...
                                    <small><a href="{{ route('admin.carCategories.show', $category) }}" target="_blank">عرض الكل</a> </small>
                                </td>
                                ...
                                <td class="text-center">
                                    <div style="display: flex" class="text-center justify-content-between">
                                        @ability('superAdmin', 'manage_cars,update_cars')
                                            <a href="{{ route('admin.carCategories.edit', $category->id) }}"
                                    ...
                                    <form action="{{ route('admin.carCategories.destroy', $category->id) }}" method="post" id="record_delete_{{ $category->id }}" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
                ...
                <div class="d-flex justify-content-center">
                    {!! $carCategories->appends(request()->input())->links() !!}
                </div>
            </div>
        </div>
    </div>
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        text: 'Delete All',
                        url: "{{ route('admin.carCategories.massDestroy') }}",
        ...
        $(function () {
            $('.status-class').change(function() {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: '{{ route('admin.carCategories.updateStatus') }}',
                    data: {
                        'status': status,
                        'cat_id': cat_id
                    },
