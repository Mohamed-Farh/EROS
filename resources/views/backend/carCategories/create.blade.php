...
@section('title', 'انشاء فئة سيارة جديدة')
...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <div class="col-6">
                <h3 class="m-0 font-weight-bold text-primary">{{__('انشاء فئة سيارة جديدة') }}</h3>
            </div>
            <div class="col-6 text-right">
                <a href="{{ route('admin.carCategories.index') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{__('فئات السيارات') }}</span>
                </a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.carCategories.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-9">
